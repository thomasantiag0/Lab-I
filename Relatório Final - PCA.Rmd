...
FactoInvestigate::Investigate(res.pca_1_pre, document = "pdf_document")
```
...
```{r}
FactoInvestigate::Investigate(res.pca, document = "pdf_document")
```
...
```{r}
FactoInvestigate::Investigate(res.pca_2_pre, document = "pdf_document")
```
...
```{r}
FactoInvestigate::Investigate(res.pca_2_pos, document = "pdf_document")
```
...
```{r}
FactoInvestigate::Investigate(res.pca_3_pre, document = "pdf_document")
```
...
```{r}
FactoInvestigate::Investigate(res.pca_3_pre_pos, document = "pdf_document")
```
